"""Rebuild 02_feature_engineering.ipynb with fixed SPEI calculation (z-score per month)."""
import json
from pathlib import Path

def md(source_lines):
    return {"cell_type": "markdown", "metadata": {}, "source": source_lines, "id": None}
...
out_path = Path(r'c:\Users\User\Downloads\Daming\spei-drought-classification-dramaga\notebooks\02_feature_engineering.ipynb')
